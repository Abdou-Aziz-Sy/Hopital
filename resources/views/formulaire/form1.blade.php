                                            ...
                                            <div class="p-5">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        name="prenom" value="{{ old('prenom') }}" placeholder="Prénom"
                                                ...
                                                <div class="form-group">
                                                    <input type="number" class="form-control form-control-lg" name="age"
                                                        ...
                                                        autocomplete="age" autofocus required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-lg"
                                                        ...
                                                        placeholder="Domicile" required autocomplete="address" autofocus
                                                        required>
                                                </div>

                                                <div class="form-group">
                                                    <select class="form-control form-control-lg" name="matrimoniale"
                                                        required>
                                                ...
                                                <h6 style="color: #20c997;">
                                                    Niveau Socio-économique</h6>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="economique"
                                                        id="inlineRadio1" value="Bon">
                                                    <label class="form-check-label" for="inlineRadio1">Bon</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="economique"
                                                        id="inlineRadio2" value="Moyen">
                                                    <label class="form-check-label" for="inlineRadio2">Moyen</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="economique"
                                                        id="inlineRadio3" value="Bas">
                                            ...
                                            <div class="p-5">
                                                ...
                                                <div class="form-group">
                                                    <input type="text"
                                                        ...
                                                        name="nom" value="{{ old('nom') }}" placeholder="Nom" required
                                                ...
                                                <div class="form-group">
                                                    <input type="text"
                                                        ...
                                                        profession="profession" value="{{ old('profession') }}"
                                                        placeholder="Profession" required autocomplete="Profession"
                                                        autofocus>
                                                    @error('profession')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                ...
                                                <h6 style="color: #20c997;">
                                                    Initiales</h6>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="initiale"
                                                        id="inlineRadio1" value="N">
                                                    <label class="form-check-label" style="color: #000;"
                                                        for="inlineRadio1">N</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="initiale"
                                                ...
                                                <br>
                                                <br>
                                                <button id="nextButton1" class="btn btn-secondary">Suivant</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
