<div class="row">
    <div class="col-lg-12">
        <!-- Fenêtre modale -->
        <div class="modal fade" id="addModals" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
            aria-hidden="true">
