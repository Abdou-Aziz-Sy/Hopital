<div class="row">
    <div class="col-lg-12">
        <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModal">Créer un
                dossier</button>
        </div>
        <!-- Fenêtre modale -->
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <!-- Premier formulaire -->
                    @include("formulaire.form1")
                    <!-- Deuxième formulaire -->
                    @include('formulaire.form2')
                    @include('formulaire.form3')
                    @include('formulaire.form4')
                    @include('formulaire.form5')
                    @include('formulaire.form6')
                    @include('formulaire.form7')
                    @include('formulaire.form8')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const createFolderButton = document.querySelector('[data-target="#addModal"]');
    ...
    createFolderButton.addEventListener('click', function() {
        ...
        if (addModal) {
            ...
            if (typeof $(addModal).modal === 'function') {
                $(addModal).modal('show');
            } else {
                console.error(
